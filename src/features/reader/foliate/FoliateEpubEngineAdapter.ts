...
import {
  ...
  FOOTNOTE_LEADING_NUMBER_RE,
  decodeFootnoteFragment,
  extractFootnoteContent,
  findFragmentElement,
  getEmbeddedFootnoteText,
  getFootnoteSemanticType,
  hasFootnoteMarkerClass,
  isBacklinkAnchor,
  isFootnoteTargetElement,
  isHeuristicCrossDocFootnoteReference,
  isHeuristicCrossDocFootnoteTarget,
  isHeuristicFootnoteReference,
  resolveCitingAnchorId,
  resolveFootnoteBody,
...
// ── Footnote popover ──────────────────────────────────────────────
// Footnote detection heuristics live in ./footnote-detection.ts (pure DOM
